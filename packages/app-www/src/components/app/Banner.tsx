...
export const Banner = () => {
  ...
  return (
    <header role="banner">
      <Section
        className={cn(
          "flex items-center justify-between gap-8 bg-blue-50 transition-all duration-200 ease-linear first-of-type:py-4",
          {
      ...
      >
        ...
        >
          ...
          <ArrowNarrowDownIcon
            className={cn("shrink-0 stroke-blue-900 transition-all duration-200 ease-linear", {
