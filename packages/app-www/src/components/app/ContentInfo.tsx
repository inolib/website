  ...
  const socialNetworks = [
    {
      ...
      icon: (
        <FacebookLogo
          aria-label="Facebook"
          className="size-8 fill-white transition-all duration-200 ease-linear group-hover/link:fill-[#0766FF]"
        />
      ),
    },
    {
      ...
      icon: (
        <LinkedInLogo
          aria-label="LinkedIn"
          className="size-8 fill-white transition-all duration-200 ease-linear group-hover/link:fill-[#0B66C2]"
        />
      ),
    },
    {
      ...
      icon: (
        <XLogo
          aria-label="X"
          className="size-8 fill-white transition-all duration-200 ease-linear group-hover/link:fill-black"
        />
      ),
    },
    {
      ...
      icon: (
        <YouTubeLogo
          aria-label="YouTube"
          className="size-8 fill-white transition-all duration-200 ease-linear group-hover/link:fill-[#FF0000]"
        />
      ),
    },
  ];
                ...
                {socialNetworks.map((item, index) => (
                  <li key={index}>
                    <Link
                      _color="transparent"
                      _shape="button"
                      className="group/link p-2 transition-all duration-200 ease-linear hover:bg-white focus-visible:outline-white"
                      href={item.href}
                      title={item.label}
                    >
                      {item.icon}
