      ...
      socialNetworks: [
        {
          ...
          icon: (
            <LinkedInIcon
              ...
              className="size-8 fill-black transition-all duration-200 group-hover/link:fill-[#0B66C2]"
              key={0}
            />
          ),
        },
              ...
              {item.socialNetworks.map((item, index) => (
                <li key={index}>
                  <Link
                    _color="transparent"
                    _shape="button"
                    className="group/link p-2 transition-all duration-200 hover:bg-white focus-visible:outline-black"
                    href={item.href}
                    title={item.label}
                  >
                    {item.icon}
