  ...
  return (
    <MenuBarSubmenu className="flex flex-col">
      <MenuBarSubmenuButton
        className={cn(
          "flex w-full items-center justify-between gap-8 rounded-lg bg-white px-4 py-2 font-semibold text-black outline-none transition-all duration-200 hover:bg-blue-50 focus-visible:outline-4 focus-visible:outline-offset-4 focus-visible:outline-black [&[aria-expanded=true]]:bg-blue-50",
          {
      ...
      >
        ...
        <span>
          <ChevronDownIcon
            className={cn(
              "stroke-black transition-all duration-200 [[aria-expanded=true]_&]:rotate-180 [[aria-expanded=true]_&]:stroke-black",
              {
      ...
      <div className="mt-0 grid grid-rows-[0fr] transition-all duration-200 [[data-expanded=true]_&]:mt-2 [[data-expanded=true]_&]:grid-rows-[1fr]">
        <BurgerNavSubmenuList className="top-[3.1875rem] flex flex-col gap-2 overflow-hidden rounded-xl border-x border-black bg-white px-2 transition-all duration-200 [[data-expanded=true]_&]:border-y [[data-expanded=true]_&]:py-2">
