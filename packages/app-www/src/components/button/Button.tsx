...
const variants = tv({
  base: "flex w-fit items-center gap-2 rounded-lg px-4 py-2 font-semibold outline-none hover:transition-all hover:duration-500 focus-visible:outline-4 focus-visible:outline-offset-4",
  variants: {
    _color: {
