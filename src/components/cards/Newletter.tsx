...
export default component$(() => {
  return (
    <>
      <div class="flex md:justify-center md:items-center bg-black bg-opacity-40">
        <div class="grid grid-cols-2 bg-white rounded-lg m-10 md:w-[50rem] md:h-[30rem] p-2">
          ...
          <form class="w-full max-w-sm md:col-start-2 relative md:flex md:flex-col h-full md:item-start bg-white p-6">
            <img src="/images/close.svg" class=" absolute top-0 right-0 -mt-3 -mr-5 scale-50" alt="Image Description" />
            ...
            <div class="mb-8 md:flex md:flex-col md:items-start">
              <div class="flex flex-col md:mb-1">
                ...
                <input
                  class="bg-gray-200 appearance-none w-[20rem] border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
                  id="inline-full-name"
                  type="text"
            ...
            <div class="md:flex md:items-center md:flex-col">
              <button
                class="sm-3 h-10 w-32 rounded-lg bg-[#0B3168] py-1 px-4 text-white shadow-lg hover:border hover:border-[#15133C] hover:bg-gray-200 hover:text-[#15133C] hover:shadow md:mt-2 md:h-10 md:w-30 md:text-lg"
                type="button"
              >
                S'inscrire
              </button>
              <a
                class=" text-gray-500 text-xs md:mt-5 visited:text-gray-500 underline-offset-1"
                href="/inscription"
                aria-label="suivre pour réinitialisier votre mot de passe"
              >
                <p class="text-center">Vous n'avez pas de compte ? Inscrivez-vous</p>
              </a>
            </div>
          </form>
        </div>
