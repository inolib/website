...
export const ServicesHomeCard = component$((props: CardProps) => {
  ...
  return (
    <>
      <article aria-label="articles" class={`mx-5 my-3 flex shadow-xl md:flex-col`}>
        <span
        ...
        <div
          class={`flex h-[8rem] w-[14rem] items-center justify-center md:h-[25rem] md:w-[17.5rem] md:flex-col md:px-4 md:pb-[10rem] md:shadow-xl`}
        >
