...
export const CardsGridDisplay = component$(() => {
  return (
    <>
      <div class="mt-6 flex flex-col md:mt-10 md:bg-slate-200" id="Formation">
        ...
        <section class="bg-white md:mx-[8rem] md:mt-[10rem] md:pb-[8rem]">
          ...
          <div class="md:grid-row-2 flex flex-col items-center md:grid md:grid-cols-2 md:gap-10 md:pt-[5rem] md:pl-[13rem]">
            <ServicesCard
            ...
            <ServicesCard image="/images/logo-dev.png" label="Description" title="Développement">
              ...
              <div q:slot="services" class="flex justify-center text-[12px] font-medium">
