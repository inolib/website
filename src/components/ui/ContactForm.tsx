...
export const ContactForm = component$(() => {
  return (
    <form class="grid grid-cols-4 grid-rows-7 md:grid-rows-5 md:px-10 py-14 md:w-2/3">
      ...
      <label class="md:col-span-2 col-span-4 row-start-2 col-start-1 md:col-end-3 col-end-5 flex flex-col mb-3 md:mb-0 md:pr-5">
        Nom
        <input
      ...
      <label class="md:col-span-2 col-span-4 row-start-3 col-start-1 col-end-5 flex flex-col mb-3 md:mb-0 md:row-start-2 md:col-start-3  md:col-end-5 md:pl-5">
        Prénom
        <input
      ...
      <label class="row-start-4 col-start-1 col-end-5 md:col-end-3 flex flex-col col-span-4 md:col-span-2 md:row-start-3 md:pr-5">
        Mail
        <input
      ...
      <label class="row-start-5 col-start-1 col-end-5 flex flex-col col-span-4 md:col-span-2 md:row-start-3 md:col-start-3 md:col-end-5 md:pl-5">
        Téléphone
        <input
      ...
      <textarea
        class="border-solid border-[1px] border-[#0B3168] col-span-4 row-start-6 col-start-1 col-end-5 mb-6 md:mb-0 md:pl-2 md:row-start-4"
