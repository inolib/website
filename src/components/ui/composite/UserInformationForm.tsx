...
export const UserInformationForm = component$(() => {
  return (
    <form class="grid-rows-7 mx-[3rem] grid grid-cols-4 py-14 text-[#0B3168] md:grid-cols-9 md:grid-rows-4">
      <select
      ...
      <label class=" md:cold-start-3 col-span-4 col-start-1 col-end-5 row-start-2 mb-3 flex flex-col md:col-span-2 md:col-end-5 md:row-start-1 md:mb-0">
        Nom
        <input
      ...
      <button class="col-span-2 col-start-1 col-end-2 row-start-7 mr-2 h-14 rounded-md hover:border-2 hover:border-[#0B3168] md:col-span-1 md:col-start-6 md:col-end-7  md:row-start-4 md:mt-14">
        Effacer
      </button>
