    ...
    <header class="overflow-x-auto">
      <section class="bg-no-repeat md:bg-[length:100rem_36rem] bg-[url('/images/home-banner.png')] md:h-[37rem] h-[44rem] md:mb-[-10rem]">
        <span class=" flex md:w-[85rem] md:h-[25rem] md:pt-[6rem]">
          ...
          />
          <h1 class="flex flex-col border-l font-semibold text-white w-min h-[15rem] text-[185%] md:text-[300%] mt-[6rem] pl-[1rem] ml-[10rem] md:mt-[0rem] md:ml-[10rem] md:pl-10">
        ...
        <span class="md:ml-[35rem] md:block flex justify-center -mt-[2rem] md:-mt-[16rem]">
          <Button
            color="white"
            href="/presentation"
            label="Découvrir"
