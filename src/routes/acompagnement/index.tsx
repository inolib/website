      ...
      <section class="text-[#0B3168]  md:mx-[8rem] md:py-8">
        ...
        >
          <div q:slot="slot1" class="md:grid grid-cols-3 grid-rows-3 gap-y-5 gap-x-9 bg-slate-100 md:p-12 md:text-lg mb-6">
            <img src="/images/dev.jpg" alt="" class="col-start-2 row-start-1 row-span-2 col-span-2 scale-75 rounded-lg" />
            ...
            <p class="col-start-1 row-start-2">
              🔹 Élaboration d'une stratégie d'accessibilité sur mesure : En adéquation avec vos objectifs,
               vos ressources internes, votre budget et les contraintes réglementaires, nous développons
              ensemble un plan d'action personnalisé.
            </p>
            ...
            <p class="col-start-2 row-start-3">
              🔹 Mise en conformité et suivi des progrès : Nous vous accompagnons dans la mise en œuvre des recommandations,
               assurons un suivi régulier et garantissons que votre site web ou application respecte les normes d'accessibilité
               en vigueur.
            </p>
            <p class="col-start-3 row-start-3">
              🔹 Support continu pour une accessibilité numérique durable : Nos experts restent à votre disposition pour vous
               assister et vous conseiller dans le maintien d'une accessibilité numérique optimale et durable.
            </p>
          </div>
        </NewArticle>
        ...
        >
          <div q:slot="slot1" class="md:grid grid-cols-3 grid-rows-3 gap-y-5 gap-x-9 bg-slate-100 md:p-12 md:text-lg mb-6">
            <img src="/images/dev-1.jpg" alt="" class="col-start-1 row-start-1 row-span-2 col-span-2 scale-75 rounded-lg" />
