        ...
        <div class="md:grid grid-cols-2 bg-white rounded-lg m-10 md:w-[50rem] md:h-[30rem] p-2">
          ...
          <form class="w-full max-w-sm md:col-start-2 relative md:flex md:flex-col h-full md:item-start bg-white p-6">
            ...
            <div class="flex items-center flex-col">
              <button
                class="sm-3 h-10 md:w-32 rounded-lg bg-[#0B3168]  py-1 px-4 text-white shadow-lg hover:border transition ease-in-out delay-150 hover:-translate-y-1  hover:scale-110 duration-300 hover:shadow md:mt-2 md:h-10 md:w-30 md:text-lg"
                type="button"
              >
                S'inscrire
              </button>
