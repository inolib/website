  ...
  return (
    <section class="px-5 md:px-10 text-[#0B3168]">
      ...
      <section class="text-l">
        <section>
          <h2 class="mb-4 text-xl font-bold">Article 1 : Collecte des informations</h2>
        ...
        <section>
          <h2 class="mb-4 text-xl font-bold">Article 2 : Utilisation des informations</h2>
          <p>
        ...
        <section>
          <h2 class="mb-4 text-xl font-bold">Article 3 : Sécurité</h2>
          <p class="mb-10">
        ...
        <section>
          <h2 class="mb-4 text-xl font-bold">Article 4 : Utilisation des cookies</h2>
          <p>
        ...
        <section>
          <h2 class="mb-4 text-xl font-bold">Article 5 : Liens vers d'autres sites</h2>
          <p class="mb-10">
        ...
        <section>
          <h2 class="mb-4 text-xl font-bold">Article 6 : Contrôle de vos informations personnelles</h2>
          <p>
            Vous pouvez choisir de restreindre la collecte ou l'utilisation de vos informations personnelles de la
            manière suivante :
          </p>
          <p class="mb-10">
            Si vous avez précédemment accepté que nous utilisions vos informations personnelles à des fins de marketing
            direct, vous pouvez changer d'avis à tout moment en nous contactant par e-mail ou par courrier à l'adresse
            indiquée sur notre site web.
          </p>
          <p>
