    ...
    <>
      ...
      <section class="text-[#0B3168]" aria-label="recrutement">
        ...
        <p class="mx-4 text-lg md:mx-[8rem] mb-10">
          Nous sommes toujours à la recherche de talents pour rejoindre notre équipe. Si vous avez des compétences, une
          passion pour l'accessibilité numérique et d'autres qualités pour une start’up, nous serons ravies de recevoir
          vos candidatures. Comment postuler ?
        </p>
